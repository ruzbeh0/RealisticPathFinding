...
// Type: Game.Simulation.RPFResourceBuyerSystem
...
public partial class RPFResourceBuyerSystem : GameSystemBase
{
    ...
    private NativeQueue<RPFResourceBuyerSystem.SalesEvent> m_SalesQueue;
    private RPFResourceBuyerSystem.TypeHandle __TypeHandle;
    ...
    protected override void OnCreate()
    {
        ...
        // ISSUE: reference to a compiler-generated field
        this.m_SalesQueue = new NativeQueue<RPFResourceBuyerSystem.SalesEvent>((AllocatorManager.AllocatorHandle)Allocator.Persistent);
        // ISSUE: reference to a compiler-generated field
    ...
    protected override void OnUpdate()
    {
        ...
        RPFResourceBuyerSystem.HandleBuyersJob jobData1 = new RPFResourceBuyerSystem.HandleBuyersJob()
        {
        ...
        // ISSUE: reference to a compiler-generated field
        this.Dependency = jobData1.ScheduleParallel<RPFResourceBuyerSystem.HandleBuyersJob>(this.m_BuyerQuery, JobHandle.CombineDependencies(this.Dependency, outJobHandle, jobHandle));
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        ...
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        RPFResourceBuyerSystem.BuyJob jobData2 = new RPFResourceBuyerSystem.BuyJob()
        {
        ...
        this.Dependency = jobData2.Schedule<RPFResourceBuyerSystem.BuyJob>(JobHandle.CombineDependencies(this.Dependency, deps));
        // ISSUE: reference to a compiler-generated field
    ...
    {
        public RPFResourceBuyerSystem.SaleFlags m_Flags;
    ...
    {
        public NativeQueue<RPFResourceBuyerSystem.SalesEvent> m_SalesQueue;
        ...
        public void Execute()
        {
            ...
            // ISSUE: variable of a compiler-generated type
            RPFResourceBuyerSystem.SalesEvent salesEvent;
            // ISSUE: reference to a compiler-generated field
            while (this.m_SalesQueue.TryDequeue(out salesEvent))
            {
                ...
                {
                    // ISSUE: reference to a compiler-generated field
                    bool flag = (salesEvent.m_Flags & RPFResourceBuyerSystem.SaleFlags.CommercialSeller) != 0;
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated field
                    ...
                    if (!this.m_Resources.HasBuffer(salesEvent.m_Seller) || EconomyUtils.GetResources(salesEvent.m_Resource, this.m_Resources[salesEvent.m_Seller]) > 0)
                    {
                        ...
                        else
                        {
                            ...
                            if (this.m_BuyingCompanies.HasComponent(salesEvent.m_Buyer))
                            {
                                ...
                                // ISSUE: reference to a compiler-generated field
                                if ((salesEvent.m_Flags & RPFResourceBuyerSystem.SaleFlags.Virtual) != RPFResourceBuyerSystem.SaleFlags.None)
                                {
                                    // ISSUE: reference to a compiler-generated field
                                    // ISSUE: reference to a compiler-generated field
                                    // ISSUE: reference to a compiler-generated field
    ...
    private struct HandleBuyersJob : IJobChunk
    {
        ...
        public NativeQueue<RPFResourceBuyerSystem.SalesEvent>.ParallelWriter m_SalesQueue;
          ...
          NativeArray<Entity> entities)
        {
            for (int index = 0; index < resourceBuyingWithTargets.Length; ++index)
            {
                ...
                if (this.m_PrefabRefData.HasComponent(buyingWithTarget.m_Payer) && this.m_PrefabRefData.HasComponent(buyingWithTarget.m_Seller))
                {
                    // ISSUE: object of a compiler-generated type is created
                    // ISSUE: variable of a compiler-generated type
                    RPFResourceBuyerSystem.SalesEvent salesEvent = new RPFResourceBuyerSystem.SalesEvent()
                    {
                        ...
                        m_Flags = RPFResourceBuyerSystem.SaleFlags.None,
          ...
          NativeArray<AttendingMeeting> meetings)
        {
            for (int index = 0; index < resourceBuyingRequests.Length; ++index)
            {
                ...
                // ISSUE: variable of a compiler-generated type
                RPFResourceBuyerSystem.SalesEvent salesEvent1;
                // ISSUE: reference to a compiler-generated field
                    ...
                    if ((pathInformation.m_State & PathFlags.Pending) == (PathFlags)0)
                    {
                        ...
                        if (this.m_Properties.HasComponent(destination) | flag1)
                        {
                            ...
                            else
                            {
                                ...
                                // ISSUE: variable of a compiler-generated type
                                RPFResourceBuyerSystem.SaleFlags saleFlags = num1 != 0 ? RPFResourceBuyerSystem.SaleFlags.CommercialSeller : RPFResourceBuyerSystem.SaleFlags.None;
                                if (virtualGood)
                                    saleFlags |= RPFResourceBuyerSystem.SaleFlags.Virtual;
                                if (flag1)
                                    saleFlags |= RPFResourceBuyerSystem.SaleFlags.ImportFromOC;
                                // ISSUE: reference to a compiler-generated field
                                // ISSUE: reference to a compiler-generated field
                                ...
                                {
                                    // ISSUE: object of a compiler-generated type is created
                                    salesEvent1 = new RPFResourceBuyerSystem.SalesEvent();
                                    // ISSUE: reference to a compiler-generated field
                                    ...
                                    // ISSUE: variable of a compiler-generated type
                                    RPFResourceBuyerSystem.SalesEvent salesEvent2 = salesEvent1;
                                    // ISSUE: reference to a compiler-generated field
                ...
                else
                {
                    ...
                    {
                        // ISSUE: variable of a compiler-generated type
                        RPFResourceBuyerSystem.SaleFlags saleFlags = RPFResourceBuyerSystem.SaleFlags.ImportFromOC;
                        // ISSUE: object of a compiler-generated type is created
                        salesEvent1 = new RPFResourceBuyerSystem.SalesEvent();
                        // ISSUE: reference to a compiler-generated field
                        salesEvent1.m_Amount = resourceBuyingRequest.m_AmountNeeded;
                        ...
                        // ISSUE: variable of a compiler-generated type
                        RPFResourceBuyerSystem.SalesEvent salesEvent3 = salesEvent1;
                        // ISSUE: reference to a compiler-generated field
                    ...
                    else
                    {
                        ...
                        if (citizens.Length > 0)
                        {
                            ...
                            // ISSUE: reference to a compiler-generated method
                            this.FindShopForCitizen(ref random, chunk, unfilteredChunkIndex, entity, resourceBuyingRequest.m_ResourceNeeded, resourceBuyingRequest.m_AmountNeeded, resourceBuyingRequest.m_Flags, citizen2, household2, householdCitizen.Length, virtualGood);
                        }
                        else
                        {
                            // ISSUE: reference to a compiler-generated method
